		...
		public String executeCommand(FabricClientCommandSource source, String command) {
			...
			try {
				ClientCommandManager.getActiveDispatcher().execute(command, new FabricClientCommandSource() {
					...
					@Override public FeatureFlagSet enabledFeatures() { return source.enabledFeatures(); }
					@Override public Collection<String> getAllTeams() { return source.getAllTeams(); }
					@Override public Stream<ResourceLocation> getAvailableSounds() { return source.getAvailableSounds(); }
